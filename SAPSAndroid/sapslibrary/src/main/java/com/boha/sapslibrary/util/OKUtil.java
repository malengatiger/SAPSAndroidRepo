...
public class OKUtil {
    ...
    public static final String DEV_URL = "http://192.168.1.233:40405/saps/main";
    public static final String PROD_URL = "http://bohamaker.com:3030/saps/main";
            ...
            public void onResponse(Response response) throws IOException {
                ...
                if (!response.isSuccessful()) {
                    ...
                    if (activity != null) {
                        ...
                        listener.onError("Problem communicating with server");
                    }
